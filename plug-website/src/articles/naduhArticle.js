  ...
  return (
    <div className="mx-6">
      ...
      <p className="text-lg font-normal">
        ...
        herself. NADUH is Vancouver’s newest girl group, and they’re “filling in
        the industry thigh gap” with their powerful and infectious presence.
      </p>
      ...
      <p className="text-lg font-normal mt-[30px]">
        ...
        pretty diverse so we have like a collage of what we’re feeling and what
        we’re into… definitely a lot of hip-hop and R&B. We all like old-school
        shit for sure.” Of course, they also confess that they wouldn’t have
        reaped their successes without Venus- yes, the goddess. The group
        divulges how “Venus put us on. She literally showed us her shiny butt
        hole and she was like go forth my children… and we were like uh, now we
        know why you’re the goddess of love and sex and everything else.”
        Keeping that in mind, the name of their latest single “On Venus” is no
        surprise.
      </p>
      ...
      <p className="text-lg font-normal mt-[30px]">
        NADUH has not only been feelin’ the love from the Vancouver music scene,
        but also the need for a sound like theirs. The singers gave much praise
        to fellow artists in the industry, echoing that “Vancouver female
        artists RULE. They rock! There’s a big connection with everybody and
        it’s a very beautiful scene, [it’s] very accepting, very
      ...
      <p className="text-lg font-normal mt-[30px]">
        ...
        group brings to the table is representation. Fans can see themselves not
        only represented but celebrated through NADUH’s music, a much-needed
        refresher in a once male-dominated industry. The vibes: simply
        impeccable.
      </p>
      ...
      <p className="text-lg font-semibold mt-[30px] italic">
        “Vancouver female artists RULE. They rock! There’s a big connection with
      ...
      <p className="text-lg font-normal mt-[30px]">
        ...
        available on Spotify, iTunes, and all other digital streaming platforms.
        The group is ready to “blast people with [their] love and FPE (fat pussy
        energy).” Give them a listen!
      </p>
